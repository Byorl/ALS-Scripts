...
--// UI Scale Support
local uiSizePercent = getgenv and getgenv().size or 100
local sizeMult = uiSizePercent / 100
print("[MacLib] UI Scale: " .. uiSizePercent .. "% (multiplier: " .. sizeMult .. ")")

--// Helper function for scaled sizes
local function scaleOffset(x, y)
	return UDim2.fromOffset(math.floor(x * sizeMult), math.floor(y * sizeMult))
end

local function scaleSize(x)
	return math.floor(x * sizeMult)
end

local function scaleUDim(scale, offset)
	return UDim.new(scale, math.floor(offset * sizeMult))
end
...
function MacLib:Window(Settings)
	...
	notificationsUIPadding.PaddingBottom = scaleUDim(0, 10)
	notificationsUIPadding.PaddingLeft = scaleUDim(0, 10)
	notificationsUIPadding.PaddingRight = scaleUDim(0, 10)
	notificationsUIPadding.PaddingTop = scaleUDim(0, 10)
	...
	base.Size = Settings.Size or scaleOffset(868, 650)

	local baseUIScale = Instance.new("UIScale")
	baseUIScale.Name = "BaseUIScale"
	baseUIScale.Scale = sizeMult
	baseUIScale.Parent = base

	local baseUICorner = Instance.new("UICorner")
	baseUICorner.Name = "BaseUICorner"
	baseUICorner.CornerRadius = scaleUDim(0, 10)
	...
	divider.Size = UDim2.new(0, scaleSize(1), 1, scaleSize(0))
	...
	uIPadding.PaddingLeft = scaleUDim(0, 11)
	uIPadding.Parent = controls

	local windowControlSettings = {
		sizes = { enabled = scaleOffset(8, 8), disabled = scaleOffset(7, 7) },
	...
	minimize.TextSize = scaleSize(14)
	...
	maximize.TextSize = scaleSize(14)
	...
	informationHolderUIPadding.PaddingBottom = scaleUDim(0, 10)
	informationHolderUIPadding.PaddingLeft = scaleUDim(0, 23)
	informationHolderUIPadding.PaddingRight = scaleUDim(0, 22)
	informationHolderUIPadding.PaddingTop = scaleUDim(0, 10)
	...
	globalSettingsButton.Size = scaleOffset(16, 16)
	...
	subtitle.TextSize = scaleSize(12)
	...
	informationGroupUIPadding.PaddingBottom = scaleUDim(0, 17)
	informationGroupUIPadding.PaddingLeft = scaleUDim(0, 25)
	...
	headshot.Size = scaleOffset(32, 32)
	...
	displayName.TextSize = scaleSize(13)
	...
	userAndDisplayFrameUIPadding.PaddingLeft = scaleUDim(0, 8)
	userAndDisplayFrameUIPadding.PaddingTop = scaleUDim(0, 3)
	...
	username.TextSize = scaleSize(12)
	...
	userInfoUIPadding.PaddingLeft = scaleUDim(0, 10)
	userInfoUIPadding.PaddingRight = scaleUDim(0, 10)
	...
	sidebarGroupUIPadding.PaddingLeft = scaleUDim(0, 10)
	sidebarGroupUIPadding.PaddingRight = scaleUDim(0, 10)
	sidebarGroupUIPadding.PaddingTop = scaleUDim(0, 31)
	...
	tabSwitchersScrollingFrameUIPadding.PaddingTop = scaleUDim(0, 2)
	...
	uIPadding2.PaddingLeft = scaleUDim(0, 20)
	uIPadding2.PaddingRight = scaleUDim(0, 20)
	...
	moveIcon.Size = scaleOffset(15, 15)
	...
	interact.TextSize = scaleSize(14)
	...
	interact.Size = scaleOffset(40, 40)
	...
	currentTab.TextSize = scaleSize(15)
	...
	globalSettingsUICorner.CornerRadius = scaleUDim(0, 10)
	...
	globalSettingsUIPadding.PaddingBottom = scaleUDim(0, 10)
	globalSettingsUIPadding.PaddingTop = scaleUDim(0, 10)
	...
	function WindowFunctions:GlobalSetting(Settings)
		...
		globalSetting.TextSize = scaleSize(14)
		...
		settingName.TextSize = scaleSize(13)
		...
		checkmark.TextSize = scaleSize(13)
	...
	function WindowFunctions:TabGroup()
		...
		uIPadding1.PaddingBottom = scaleUDim(0, 15)
		...
		function SectionFunctions:Tab(Settings)
			...
			tabSwitcher.TextSize = scaleSize(14)
			...
			if Settings.Image then
				...
				tabImage.Size = scaleOffset(18, 18)
			...
			tabSwitcherName.TextSize = scaleSize(16)
			...
			tabSwitcherUIPadding.PaddingLeft = scaleUDim(0, 24)
			tabSwitcherUIPadding.PaddingRight = scaleUDim(0, 35)
			tabSwitcherUIPadding.PaddingTop = scaleUDim(0, 1)
			...
			elementsUIPadding.PaddingRight = scaleUDim(0, 5)
			elementsUIPadding.PaddingTop = scaleUDim(0, 10)
			elementsUIPadding.PaddingBottom = scaleUDim(0, 10)
			...
			elementsScrollingUIPadding.PaddingBottom = scaleUDim(0, 5)
			elementsScrollingUIPadding.PaddingLeft = scaleUDim(0, 11)
			elementsScrollingUIPadding.PaddingRight = scaleUDim(0, 3)
			elementsScrollingUIPadding.PaddingTop = scaleUDim(0, 5)
			...
			function TabFunctions:Section(Settings)
				...
				sectionUIPadding.PaddingBottom = scaleUDim(0, 20)
				sectionUIPadding.PaddingLeft = scaleUDim(0, 20)
				sectionUIPadding.PaddingRight = scaleUDim(0, 18)
				sectionUIPadding.PaddingTop = scaleUDim(0, 22)
				...
				function SectionFunctions:Button(Settings, Flag)
					...
					buttonInteract.TextSize = scaleSize(13)
					...
					buttonImage.Size = scaleOffset(15, 15)
				...
				function SectionFunctions:Toggle(Settings, Flag)
					...
					toggleName.TextSize = scaleSize(13)
					...
					toggle1.Size = scaleOffset(41, 21)
					toggle1.ImageTransparency = 0.5

					local toggleUIPadding = Instance.new("UIPadding")
					toggleUIPadding.Name = "ToggleUIPadding"
					toggleUIPadding.PaddingBottom = scaleUDim(0, 1)
					toggleUIPadding.PaddingLeft = UDim.new(0, -2)
					toggleUIPadding.PaddingRight = scaleUDim(0, 3)
					toggleUIPadding.PaddingTop = scaleUDim(0, 1)
					...
					togglerHead.Size = scaleOffset(15, 15)
				...
				function SectionFunctions:Slider(Settings, Flag)
					...
					sliderName.TextSize = scaleSize(13)
					...
					sliderValue.TextSize = scaleSize(12)
					...
					sliderValue.Size = scaleOffset(41, 21)
					...
					sliderValueUICorner.CornerRadius = scaleUDim(0, 4)
					...
					sliderValueUIPadding.PaddingLeft = scaleUDim(0, 2)
					sliderValueUIPadding.PaddingRight = scaleUDim(0, 2)
					...
					sliderBar.Size = scaleOffset(123, 3)
					...
					sliderHead.Size = scaleOffset(12, 12)
					...
					sliderElementsUIPadding.PaddingTop = scaleUDim(0, 3)
				...
				function SectionFunctions:Input(Settings, Flag)
					...
					inputName.TextSize = scaleSize(13)
					...
					inputBox.TextSize = scaleSize(12)
					...
					inputBox.Size = scaleOffset(21, 21)
					...
					inputBoxUICorner.CornerRadius = scaleUDim(0, 4)
					...
					inputBoxUIPadding.PaddingLeft = scaleUDim(0, 5)
					inputBoxUIPadding.PaddingRight = scaleUDim(0, 5)
				...
				function SectionFunctions:Keybind(Settings, Flag)
					...
					keybindName.TextSize = scaleSize(13)
					...
					binderBox.TextSize = scaleSize(12)
					...
					binderBoxUIPadding.PaddingLeft = scaleUDim(0, 5)
					binderBoxUIPadding.PaddingRight = scaleUDim(0, 5)
				...
				function SectionFunctions:Dropdown(Settings, Flag)
					...
					dropdownUIPadding.PaddingLeft = scaleUDim(0, 15)
					dropdownUIPadding.PaddingRight = scaleUDim(0, 15)
					...
					dropdownName.TextSize = scaleSize(13)
					...
					dropdownUICorner.CornerRadius = scaleUDim(0, 6)
					...
					dropdownImage.Size = scaleOffset(14, 14)
					...
					dropdownFrameUIPadding.PaddingTop = scaleUDim(0, 38)
					dropdownFrameUIPadding.PaddingBottom = scaleUDim(0, 10)
					...
					searchIcon.Size = scaleOffset(12, 12)
					searchIcon.Parent = search

					local uIPadding = Instance.new("UIPadding")
					uIPadding.Name = "UIPadding"
					uIPadding.PaddingLeft = scaleUDim(0, 15)
					...
					searchBox.TextSize = scaleSize(14)
					...
					local uIPadding1 = Instance.new("UIPadding")
					uIPadding1.Name = "UIPadding"
					uIPadding1.PaddingLeft = scaleUDim(0, 23)
					...
					local function addOption(i, v)
						...
						optionUIPadding.PaddingLeft = scaleUDim(0, 15)
						...
						optionName.TextSize = scaleSize(13)
				...
				function SectionFunctions:Colorpicker(Settings, Flag)
					...
					colorpickerName.TextSize = scaleSize(13)
					...
					colorCbg.TileSize = scaleOffset(500, 500)
					...
					colorCbg.Size = scaleOffset(21, 21)
					...
					local uICorner = Instance.new("UICorner")
					uICorner.Name = "UICorner"
					uICorner.CornerRadius = scaleUDim(0, 6)
					...
					local uICorner1 = Instance.new("UICorner")
					uICorner1.Name = "UICorner"
					uICorner1.CornerRadius = scaleUDim(0, 8)
					...
					slide.Size = UDim2.new(0, scaleSize(13), 1, scaleSize(8))
					...
					local uICorner1 = Instance.new("UICorner")
					uICorner1.Name = "UICorner"
					uICorner1.CornerRadius = scaleUDim(0, 6)
					...
					wheel1.Size = scaleOffset(220, 220)
					...
					inputBox.LayoutOrder = 1
					inputBox.Position = UDim2.fromScale(1, 0.5)
					inputBox.Size = scaleOffset(75, 25)
					...
					local inputBoxUIPadding = Instance.new("UIPadding")
					inputBoxUIPadding.Name = "InputBoxUIPadding"
					inputBoxUIPadding.PaddingLeft = scaleUDim(0, 8)
					inputBoxUIPadding.PaddingRight = scaleUDim(0, 10)
					inputBoxUIPadding.Parent = inputBox
					...
					inputName1.TextSize = scaleSize(13)
					...
					inputBox1.TextSize = scaleSize(12)
					...
					inputBoxUIPadding1.PaddingLeft = scaleUDim(0, 8)
					inputBoxUIPadding1.PaddingRight = scaleUDim(0, 10)
					...
					inputName2.TextSize = scaleSize(13)
					...
					inputBox2.TextSize = scaleSize(12)
					...
					inputBoxUIPadding2.PaddingLeft = scaleUDim(0, 8)
					inputBoxUIPadding2.PaddingRight = scaleUDim(0, 10)
					...
					inputName3.TextSize = scaleSize(13)
					...
					inputBox3.TextSize = scaleSize(12)
					...
					inputBoxUIPadding3.PaddingLeft = scaleUDim(0, 8)
					inputBoxUIPadding3.PaddingRight = scaleUDim(0, 10)
					...
					inputName4.TextSize = scaleSize(13)
					...
					inputBox4.TextSize = scaleSize(12)
					...
					inputBoxUIPadding4.PaddingLeft = scaleUDim(0, 8)
					inputBoxUIPadding4.PaddingRight = scaleUDim(0, 10)
					...
					local uIPadding = Instance.new("UIPadding")
					uIPadding.Name = "UIPadding"
					uIPadding.PaddingRight = scaleUDim(0, 5)
					...
					uIGridLayout.CellPadding = scaleOffset(10, 0)
					...
					newColor.TileSize = scaleOffset(500, 500)
					...
					newColor.Size = scaleOffset(100, 100)
					...
					oldColor.TileSize = scaleOffset(500, 500)
					...
					oldColor.Size = scaleOffset(100, 100)
					...
					local uIPadding1 = Instance.new("UIPadding")
					uIPadding1.Name = "UIPadding"
					uIPadding1.PaddingBottom = scaleUDim(0, 9)
					uIPadding1.PaddingLeft = scaleUDim(0, 10)
					uIPadding1.PaddingRight = scaleUDim(0, 10)
					uIPadding1.PaddingTop = scaleUDim(0, 9)
					...
					baseUICorner1.CornerRadius = scaleUDim(0, 10)
					baseUICorner1.Parent = cancel

					local uIPadding2 = Instance.new("UIPadding")
					uIPadding2.Name = "UIPadding"
					uIPadding2.PaddingBottom = scaleUDim(0, 9)
					uIPadding2.PaddingLeft = scaleUDim(0, 10)
					uIPadding2.PaddingRight = scaleUDim(0, 10)
					uIPadding2.PaddingTop = scaleUDim(0, 9)
					...
					uIPadding3.PaddingTop = scaleUDim(0, 10)
					...
					local globalSettingsUIPadding = Instance.new("UIPadding")
					globalSettingsUIPadding.Name = "GlobalSettingsUIPadding"
					globalSettingsUIPadding.PaddingBottom = scaleUDim(0, 20)
					globalSettingsUIPadding.PaddingLeft = scaleUDim(0, 20)
					globalSettingsUIPadding.PaddingRight = scaleUDim(0, 20)
					globalSettingsUIPadding.PaddingTop = scaleUDim(0, 20)
					...
					paragraphHeader.TextSize = scaleSize(18)
					...
					uIPadding4.PaddingBottom = scaleUDim(0, 15)
				...
				function SectionFunctions:Header(Settings, Flag)
					...
					local uIPadding = Instance.new("UIPadding")
					uIPadding.Name = "UIPadding"
					uIPadding.PaddingBottom = scaleUDim(0, 5)
					...
					headerText.TextSize = scaleSize(16)
				...
				function SectionFunctions:Label(Settings, Flag)
					...
					labelText.TextSize = scaleSize(13)
				...
				function SectionFunctions:SubLabel(Settings, Flag)
					...
					subLabelText.TextSize = scaleSize(12)
				...
				function SectionFunctions:Paragraph(Settings, Flag)
					...
					paragraphHeader.TextColor3 = Color3.fromRGB(255, 255, 255)
					paragraphHeader.TextSize = scaleSize(15)
					paragraphHeader.TextTransparency = 0.4
					paragraphHeader.TextWrapped = true
					...
					paragraphBody.TextSize = scaleSize(13)
				...
				function SectionFunctions:Divider()
					...
					local uIPadding = Instance.new("UIPadding")
					uIPadding.Name = "UIPadding"
					uIPadding.PaddingBottom = scaleUDim(0, 8)
					uIPadding.PaddingTop = scaleUDim(0, 8)
	...
	function WindowFunctions:Notify(Settings)
		...
		notificationUICorner.CornerRadius = scaleUDim(0, 10)
		...
		notificationTitle.TextSize = scaleSize(13)
		...
		notificationTitleUIPadding.PaddingRight = scaleUDim(0, 25)
		...
		notificationDescription.TextSize = scaleSize(11)
		...
		notificationDescriptionUIPadding.PaddingRight = scaleUDim(0, 25)
		notificationDescriptionUIPadding.PaddingTop = scaleUDim(0, 17)
		...
		notificationUIPadding.PaddingBottom = scaleUDim(0, 12)
		notificationUIPadding.PaddingLeft = scaleUDim(0, 10)
		notificationUIPadding.PaddingRight = scaleUDim(0, 10)
		notificationUIPadding.PaddingTop = scaleUDim(0, 10)
		...
		interactable.TextSize = scaleSize(17)
		...
		local uIPadding = Instance.new("UIPadding")
		uIPadding.Name = "UIPadding"
		uIPadding.PaddingBottom = scaleUDim(0, 6)
		uIPadding.PaddingRight = scaleUDim(0, 13)
		uIPadding.PaddingTop = scaleUDim(0, 6)
		...
		local tweens = {
			In = Tween(notificationUIScale, TweenInfo.new(0.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
				Scale = (Settings.Scale or 1) * sizeMult
			}),
	...
	function WindowFunctions:Dialog(Settings)
		...
		dialogUICorner.CornerRadius = scaleUDim(0, 10)
		...
		paragraphBody.TextColor3 = Color3.fromRGB(255, 255, 255)
		paragraphBody.TextSize = scaleSize(14)
		paragraphBody.TextTransparency = 0.5
		paragraphBody.TextWrapped = true
		paragraphBody.AutomaticSize = Enum.AutomaticSize.Y
		paragraphBody.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		...
		local uIPadding = Instance.new("UIPadding")
		uIPadding.Name = "UIPadding"
		uIPadding.PaddingTop = scaleUDim(0, 20)
